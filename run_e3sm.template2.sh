...
# Machine and project
readonly MACHINE=pm-cpu # LM changed cori-knl to perlmutter
...
readonly CASE_NAME="v2.LR21" # LM changed from your_casename to v2.LR.piControl, per confluence doc
# If this is part of a simulation campaign, ask your group lead about using a case_group label
# readonly CASE_GROUP=""

# Code and compilation
readonly CHECKOUT="20210806_test13" # use this unless i want to 'get' code again?
...
#readonly RUN_REFDIR="/global/homes/l/lili/E3SMv2/${CASE_NAME}/init" # LM changed RUN_REFDIR filepath
...
#readonly CASE_ROOT="${SCRATCH}/E3SMv2/code/${CASE_NAME}"
readonly CASE_ROOT="/pscratch/sd/l/lili/${CASE_NAME}" # LM changed CASE_ROOT filepath
...
cat << EOF >> user_nl_eam
 ...
 fincl2 = 'FLUT','PRECT','U200','V200','U850','V850','Z500','OMEGA500','UBOT','VBOT','TREFHT','TREFHTMN:M','TREFHTMX:X','QREFHT','TS','PS','TMQ','TUQ','TVQ','TOZ', 'FLDS', 'FLNS', 'FSDS', 'FSNS', 'SHFLX', 'LHFLX', 'TGCLDCWP', 'TGCLDIWP', 'TGCLDLWP', 'CLDTOT', 'T250', 'T200', 'T150', 'T100', 'T050', 'T025', 'T010', 'T005', 'T002', 'T001', 'TTOP', 'U250', 'U150', 'U100', 'U050', 'U025', 'U010', 'U005', 'U002', 'U001', 'UTOP', 'FSNT'
 fincl3 = 'PSL','T200','T500','U850','V850','UBOT','VBOT','TREFHT', 'Z700', 'TBOT:M', 'FLUT', 'TS', 'FLDS', 'FLNS', 'TGCLDCWP', 'LHFLX', 'SHFLX', 'FSDS', 'FSNS', 'FSNT', 'QRL', 'LWCF', 'FUL', 'FDL'
