  ...
  subroutine atm_import( x2a, cam_in, restart_init )
    ...
    do c=begchunk,endchunk
       ...
       do i =1,ncols                                                               
          ...
          cam_in(c)%lwdn_prev(i) =  x2a(index_x2a_Faxx_lwdn_prev,ig) ! LM 
          print *, "LM atm_import_export lwup = ", cam_in(c)%lwup(i) 
          print *, "LM atm_import_export lwdn_prev = ", cam_in(c)%lwdn_prev(i) 
