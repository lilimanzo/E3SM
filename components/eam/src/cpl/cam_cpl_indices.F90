module cam_cpl_indices
  ...
  integer :: index_x2a_Faxx_lwdnprev   ! LM added downward lw from prev cpl interval
  integer :: index_x2a_Faxx_lwdnprev3  ! LM added downward lw from prev cpl interval- prev3
...
contains
  ...
  subroutine cam_cpl_indices_set( )
    ...
    index_x2a_Faxx_lwdnprev = mct_avect_indexra(x2a,'Faxx_lwdnprev') ! LM added
    index_x2a_Faxx_lwdnprev3= mct_avect_indexra(x2a,'Faxx_lwdnprev3') ! LM added
