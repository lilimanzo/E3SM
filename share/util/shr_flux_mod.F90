...
SUBROUTINE shr_flux_atmOcn(nMax  ,zbot  ,ubot  ,vbot  ,thbot ,   &
           ...
           &               sen   ,lat   ,lwup  ,lwdn  ,lwup_gb ,   & ! LM added lwdn, lwup_gb
           &               r16O, rhdo, r18O, &
...
! !INPUT/OUTPUT PARAMETERS:
   ...
   real(R8)   ,intent(in) :: lwdn (nMax) ! LM added downwelling flux
   ...
   real(R8),intent(out)  ::  lwup_gb(nMax) ! LM diagnostic GB flux (W/m^2)
...
!!.................................................................
   ...
   DO n=1,nMax
     if (mask(n) /= 0) then
        ...
        lwup_gb(n) = spval  ! LM diagnostic gb long-wave upward heat flux  (W/m^2)
