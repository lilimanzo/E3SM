...
101 format('avloc_diag ',a3,1x,a4,1x,i3,es26.19,1x,a)
  ...
  subroutine seq_diag_saf(atm, frac_a, a2x_a, saf) ! LM created subroutine
        ...
        do n=1,lSize
                ...
                x2a_a % rAttr(index_x2a_Sx_saf, n) = & ! (Fup - Fdn) / (stebol * (ifrac* ((iFup - (1-e1)Fdn)/(stebol*e1))**.25) - fdn)
                        ...
                        / ( shr_const_stebol * x2a_a%rAttr(index_x2a_Si_taf,n) ))**.25 ) - a2x_a%rAttr(index_a2x_Faxa_lwdn,n)) 
                        !/ (shr_const_stebol * ( frac_a%rAttr(ki,n) * ( (frac_a%rAttr(ki,n) * x2a_a%rAttr(index_x2a_Faxx_lwup,n) &
                        !-(1-x2a_a%rAttr(index_x2a_Si_taf,n))*a2x_a%rAttr(index_a2x_Faxa_lwdn,n)  ) &
