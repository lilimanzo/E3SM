  ...
  subroutine seq_diag_saf(atm, frac_a, a2x_a, saf) ! LM created subroutine
        ...
        do n=1,lSize
                ...
                x2a_a % rAttr(index_x2a_Sx_saf, n) = &
                        ...
                        / (shr_const_stebol * (frac_a%rAttr(kir,n) * ((-frac_a%rAttr(kir,n) * x2a_a%rAttr(index_x2a_Faxx_lwup,n) - &
                        (1 - x2a_a%rAttr(index_x2a_Si_taf,n)) * a2x_a%rAttr(index_a2x_Faxa_lwdn,n) ) & 
                        / ( shr_const_stebol * x2a_a%rAttr(index_x2a_Si_taf,n) ))**.25 + frac_a%rAttr(kor,n) &
                ...
                x2a_a % rAttr(index_x2a_Sx_tr, n) = sqrt((-x2a_a%rAttr(index_x2a_Faxx_lwup,n)- &
